...
const distDir = path.join(root, "dist", "employeeportal");
...
console.log("Packaging employeeportal production build...");
...
console.log(distDir);
console.log(`Run it with: cd dist\\employeeportal && node server.js`);
