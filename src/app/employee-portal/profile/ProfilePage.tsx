...
export default function ProfilePage() {
  ...
  return (
    <div className={Ustyles.dashboardContainer}>
      {/* Title Section */}
      <div className={Ustyles.sectionHeader}>
        <h2 className={Ustyles.pageTitle}>Profile</h2>
      </div>

      <div className={Ustyles.sectionDivider}></div>
      ...
      {/* Form Section (grid same as dashboard cards) */}
